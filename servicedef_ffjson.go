...
func (mj *ServiceDefinition) MarshalJSON() ([]byte, error) {
...
const (
	ffj_t_ServiceDefinitionbase = iota
	ffj_t_ServiceDefinitionno_such_key

	ffj_t_ServiceDefinition_Type

	ffj_t_ServiceDefinition_ContainerPort

	ffj_t_ServiceDefinition_NamePattern
)

var ffj_key_ServiceDefinition_Type = []byte("type")

var ffj_key_ServiceDefinition_ContainerPort = []byte("container_port")

var ffj_key_ServiceDefinition_NamePattern = []byte("name_pattern")
